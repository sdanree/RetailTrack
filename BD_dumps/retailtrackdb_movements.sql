...
CREATE TABLE `movements` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_Movements_MovementTypeId` (`MovementTypeId`),
  CONSTRAINT `FK_Movements_MovementTypes_MovementTypeId` FOREIGN KEY (`MovementTypeId`) REFERENCES `movementtypes` (`Movement_Id`) ON DELETE CASCADE
