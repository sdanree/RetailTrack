...
namespace RetailTrack.Migrations
{
    ...
    [Migration("20250320162003_AddAvailableToProductStock")]
    partial class AddAvailableToProductStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailTrack.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RetailTrack.Models.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RetailTrack.Models.OrderPayment", b =>
                {
            ...
            modelBuilder.Entity("RetailTrack.Models.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RetailTrack.Models.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RetailTrack.Models.Order", b =>
                {
                    b.HasOne("RetailTrack.Models.OrderStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("RetailTrack.Models.OrderDetail", b =>
                {
                    b.HasOne("RetailTrack.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RetailTrack.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("RetailTrack.Models.ProductStock", b =>
                {
                    ...
                    b.HasOne("RetailTrack.Models.MaterialSize", "MaterialSize")
                        .WithMany()
                        .HasForeignKey("MaterialId", "SizeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
